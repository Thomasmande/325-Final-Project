...
lm_let <- lm(difflet ~ viewcat + sex + age + setting + + prelet + site + viewenc, data = sesame)
lm_numb <- lm(diffnumb ~ viewcat + sex + age + setting + + prenumb + site + viewenc, data = sesame)
...
```{r}
myvars <- c("site", "sex", "age", "viewcat", "setting", "viewenc", "prelet", "difflet")
...
```{r}
myvars2 <- c("site", "sex", "age", "viewcat", "setting", "viewenc", "prenumb", "diffnumb")
